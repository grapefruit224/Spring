...
public class BoardPostController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<BoardPostDto> updateBoardPost(@PathVariable("id") Long id, @RequestBody BoardPostDto boardPostDto){
        BoardPostDto updateBoardPostDto = boardPostService.updateBoardPost(id, boardPostDto);
        return ResponseEntity.ok(updateBoardPostDto);
    }
